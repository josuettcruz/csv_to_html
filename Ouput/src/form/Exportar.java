...
public class Exportar {
    ...
    private String phrase(String dig, int note, String divide, String q1, String q2){
    ...
    private String T(String text, String separator, String q1, String q2){
        ...
        for(String tx : dig){
            ...
            if(tx.contains("<") || tx.contains(">")){//if
                ...
                txt += phrase(tx, col, separator, q1, q2);
    ...
    private String T(String txt,String divide){
        
        return T(txt,divide, "<q>", "</q>");
    ...
    private String P(String paragraphy){
        ...
        String divide = paragraphy.length() > long_text && !paragraphy.contains("|") && !paragraphy.contains("\\") ? "_" : "*";
        
        String q1 = paragraphy.length() > long_text && !paragraphy.contains("|") && !paragraphy.contains("\\") ? "<q>*" : "``";
        String q2 = paragraphy.length() > long_text && !paragraphy.contains("|") && !paragraphy.contains("\\") ? "*</q>" : "´";
        
        String txt = "<p class=\"";
        txt += classe;
        txt += "\">";
        txt += divide;
        txt += T(paragraphy,divide + "<br/>" + divide, q1, q2);
        txt += divide;
        txt += "</p>";
    ...
    private String P(String paragraphy, String link){
        ...
        String txt = "<p class=\"texto_link\"><q>*<a href=\"";
        txt += link;
        txt += "\" target=\"_";
        txt += this.target;
        txt += "\">";
        txt += T(paragraphy, "</a>*<br/>*<a href=\"" + link + "\" + target=\"" + this.target + "\">");
        txt += "</a>*</q></p><p class=\"texto_hiperlink\"><q>`";
        txt += link;
        txt += "`</q></p>";
    ...
    public void Export(String name){
        ...
        if(cd){
            ...
            if(extend){
                ...
                doc.add("      background-color:lightskyblue;");
                doc.add("   }");
                
            }//if(extend)
            
            doc.add("   h1.tema::selection{");
            doc.add("      background-color:lightblue;");
            doc.add("   }");
            ...
            if(this.link){
                ...
                doc.add("      background-color:whitesmoke;");
                doc.add("   }");
                doc.add("   p.texto_hiperlink::selection{");
                doc.add("      color:black;");
                doc.add("      background-color: gray;");
                doc.add("   }");
                ...
                if(mpeg(this.code.Read(x, 0))){
                    ...
                    switch(this.code.Read(x, 0).substring(max+1).toLowerCase()){
                        ...
                        case "mp4" ->{
                            ...
                            arq_1 += this.h1;
                            arq_1 += "\"><q>*";
                            arq_1 += T(this.code.Read(x, 0).substring(0,max),"*</q><br/><q>*");
                            arq_2 = T(this.code.Read(x, 0).substring(0,max),"*</q><br/><q>*");
                        ...
                        case "avi" ->{
                            ...
                            arq_1 += "<h1 class=\"arquivo\">VÍDEO: ";
                            arq_1 += Numb(arquivo+1, all_vcr);
                            arq_1 += "</q></h1><div class=\"space\"></div><h1 class=\"";
                            arq_1 += this.h1;
                            arq_1 += "\"><q>*";
                            arq_1 += T(this.code.Read(x, 0).substring(0,max),"*</q><br/><q>*").toUpperCase();
                    ...
                    if(y == 0){
                        ...
                        if(ext_val){
                            ...
                            if(sub_arq == into_arq){
                                ...
                                tx += this.h1;
                                tx += "\"><q>*";
                                tx += T(this.code.Read(x, 0), "*</q><br/><q>*");
                                tx += "*</q></h1>";
